...
$api->addRoute('GET', '/api-libros/api/libros/paginas/order-desc', function() {
    $libro = new Libro();
    return $libro->OrdenarPaginasDesc();
});

$api->addRoute('GET', '/api-libros/api/libros/paginas/order-asc', function() {
    $libro = new Libro();
    return $libro->OrdenarPaginasAsc();
});

$api->addRoute('GET', '/api-libros/api/libros/paginas/max', function() {
    $libro = new Libro();
    $maximoPaginas = $_GET["paginas"] ?? null;
    return $libro->maxPaginas($maximoPaginas);
});

$api->addRoute('GET', '/api-libros/api/libros/paginas/min', function() {
    $libro = new Libro();
